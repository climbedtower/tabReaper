#!/usr/bin/env node
/**
 * 失敗リストの clip について Jina で本文取得（30s timeout）。
 * 使い方: node scripts/jina-fetch-retry.js
...
const RETRY_FILES = [
  '20251206プレイヤーの体験に直結するゲームシステム設計を最優先し、その.md',
  '20251207AIツール「Antigravity」により事務タスクの自動化.md',
  ...
  'p-AIエージェントとファイルシステム_5d687b5b.md',
  ...
  'p-x-検索エンジン等を作るべき_53122f86.md',
  'p-x-漢方の効果と課題_be140bf6.md',
  'p-x-習慣化とChatGPT活用_0f262bda.md',
  'p-x-色彩に関するXの投稿_47bd3ee9.md',
  'p-x-花粉症が完治_0813e01d.md',
